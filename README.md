...
- The background images that you see are from [source.unsplash.com](https://source.unsplash.com/). Bacground images in the app will change accordingly to the location and the current day-night time of that location.
